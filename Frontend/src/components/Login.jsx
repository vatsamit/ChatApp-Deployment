...
<p className='text-white'>Have an Account?<Link to= "/signup" className='text-blue-500 cursor-pointer underline ml-1'>.Signup</Link></p>
<input type='submit' value="Login" className='text-white px-4 py-2 bg-green-500 rounded-lg cursor-pointer'/>
</div>
